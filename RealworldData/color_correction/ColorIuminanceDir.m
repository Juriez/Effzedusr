...
ref_folder  = 'C:/BSG team_z/PYTHON/zareen/ZeDuSR/RealworldData/Data//WideView_crop_bic/';
input_folder  = 'C:/BSG team_z/PYTHON/zareen/ZeDuSR/RealworldData/Data/TeleView_SIFTAlign/';
save_folder = 'C:/BSG team_z/PYTHON/zareen/ZeDuSR/RealworldData/Data/TeleView_SIFTAlign_cor/';

% filepaths = dir(fullfile(ref_folder, '*.png')); % iPhone12
filepaths = dir(fullfile(ref_folder, '*.jpeg')); % iPhone11
