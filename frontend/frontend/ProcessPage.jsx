    ...
    const runPipeline = async () => {
        ...
        try {
            ...
            if (res.data.status === "success") {
                ...
                localStorage.setItem("processedImageName", imageName);
            } else {
        ...
        `}
            ...
            <div style={styles.card}>
                <div style={styles.header}>
                    <h1 style={styles.title}>⚙️ Process Images</h1>
                    <p style={styles.subtitle}>Enter image name and start the enhancement pipeline</p>
                </div>
                ...
                <div style={styles.content}>
                    ...
                    <div style={styles.processCard}>
                        <label style={styles.label}>🏷️ Image Name for Processing</label>
                    ...
                    {processComplete && (
                        <button
                            ...
                            onClick={() => navigate("/zedusr/results")}
                            onMouseEnter={(e) => {
                                e.target.style.transform = "translateY(-2px)";
                    ...
                    {!processComplete && (
                        <div style={styles.infoBox}>
                            ...
                            <ul style={{ margin: "12px 0 0 0", paddingLeft: "22px" }}>
                                <li>Image resizing and alignment</li>
                                <li>Deep learning enhancement</li>
                                <li>Super-resolution processing</li>
