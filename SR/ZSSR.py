...
parser.add_argument('--train_lr', type=str,
                    default='../SynthesizedData/Data/DIAlign/artroom_isoJPEG2x/artroom/out_1000_warp.png')
parser.add_argument('--train_hr', type=str,
                    default='../SynthesizedData/Data/DIAlign/artroom_isoJPEG2x/artroom/HR.png')
parser.add_argument('--Invari_map', type=str,
                    default='../SynthesizedData/Data/DIAlign/artroom_isoJPEG2x/artroom/PatchDisOut.npy')

parser.add_argument('--test_lr', type=str,
                    default='../SynthesizedData/Data/WideView_iso2x_JPEG75/artroom.jpg')
parser.add_argument('--test_hr', type=str,
                    default='../SynthesizedData/Data/WideView_GT/artroom.jpg')


# evaluation option
parser.add_argument('--eval_interval', type=int, default=10, help='evaluation interval')
parser.add_argument('--dataset', type=str, default='artroom_isoJPEG2x/artroom', help='save DirName')
